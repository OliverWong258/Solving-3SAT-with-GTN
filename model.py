...
class network(torch.nn.Module):
    ...
    def forward(self, x, edge_attr, edge_index, batch_index):
        ...
        x = self.softplus(self.init_linear_layer(x))
        ...
        for i in range(self.n_layers):
            ...
            x = self.softplus(self.linear_layers[i](x))
        ...
        # output block
        x = self.softplus(self.linear_layer1(x))
        x = self.softplus(self.linear_layer2(x))
